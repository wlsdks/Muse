...
`node --test "harness/runner/*.test.mjs"`(현재 **27/27**)를 강제 — 회귀가 머지 전에 막힘.
...
병렬 리서치 워크플로(5 에이전트)로 최신(v2.1.158·Opus 4.8) 사실을 모아 [claude-code-integration §7·§8]
(claude-code-integration.md)에 추가.
...
인용 추가([verification-and-guardrails 도입부](verification-and-guardrails.md)).
