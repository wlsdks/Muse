...
| `context-strategy` | Context engineering — leanest sufficient context per turn (worktree `/tmp/muse-context-strategy`, branch `loop/context-strategy`) | [context-strategy.md](context-strategy.md) | 3 | `3e3dbf8e` | v1.14.0 | active (cron `6ba58123`, session-only, Tier2 push+PR, merge-to-main every 5 fires) |
