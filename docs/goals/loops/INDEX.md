...
| `test-hygiene` | 테스트 스위트 위생 — 저가치/중복 제거 + 누락 고가치 추가 (mutation-first) (worktree `test-hygiene`) | [test-hygiene.md](test-hygiene.md) | 2 | (fire 2) | v1.14.0 | active (cron `a3abcba0`, session-only) |
