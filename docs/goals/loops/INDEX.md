...
| `tool-mcp-browser` | TOOL 확장+하드닝 · 공식 공개 외부 MCP(Notion/GitHub) · muse-in-chrome (worktree `tool-mcp-browser`) | [tool-mcp-browser.md](tool-mcp-browser.md) | 8 | (fire 8 ↩ rollback) | v1.14.0 | active (cron `d410848c`, session-only) |
