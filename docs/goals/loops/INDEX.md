...
| `context-strategy` | Context engineering — leanest sufficient context per turn (worktree `/tmp/muse-context-strategy`, branch `loop/context-strategy`) | [context-strategy.md](context-strategy.md) | 6 | `8c0341d9` | v2.0.0 | active (cron `c66c8b81`, session-only, Tier2 push+PR, merge-to-main every 5 fires) |
