...
| `grounded-vision` | 근거-있는 비전/멀티모달 — 이미지→근거-추출→draft-first 액션 (worktree `/tmp/muse-grounded-vision`, branch `loop/grounded-vision`, Tier2 push, merge-based git) | [grounded-vision.md](grounded-vision.md) | 4 | `5b66ce16` | v2.0.0 | active (cron `abd98181`, session-only; replaces stopped paper-grounded) |
