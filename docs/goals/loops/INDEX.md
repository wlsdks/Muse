...
| `differentiation` | 경쟁 차별점 발굴 → edge 확장 vs hermes/openclaw (worktree `/tmp/muse-differentiation`) | [differentiation.md](differentiation.md) | 5 | `<pending>` | v1.14.0 | active (cron `80c4074b`, session-only) |
