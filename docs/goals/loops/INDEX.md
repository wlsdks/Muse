...
| `surfaces` | 제품 표면 강화 — CLI · macOS desktop · web · web콘솔 API (worktree `/tmp/muse-surfaces`, branch `loop/surfaces`) | [surfaces.md](surfaces.md) | 60 | `<pending>` | v2.0.0 | active (cron `87c1b283`, session-only 20m, /tmp/muse-surfaces; fire 60=3배수 main-merge) |
