...
| `surfaces` | 제품 표면 강화 — CLI · macOS desktop · web (worktree `/tmp/muse-surfaces`, branch `loop/surfaces`) | [surfaces.md](surfaces.md) | 55 | `7b2f708c` | v2.0.0 | active (manual this session; cron `c5b90c94` deleted — raced same worktree) |
...
| `self-improvement` | hermes-style 자기개선 머신러리 — Playbook RL · whetstone · Skill 작성 · Reflection/dreaming · memory consolidation (worktree `/tmp/muse-self-improvement`, branch `loop/self-improvement`, Tier1.5 local-main merge ea 3 fires) | [self-improvement.md](self-improvement.md) | 3 | `b801ab88` | v2.0.0 | active (cron `0b48bb96`, session-only) |
