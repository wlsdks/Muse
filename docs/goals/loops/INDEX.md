...
| `differentiation` | 경쟁 차별점 발굴 → edge 확장 vs hermes/openclaw (worktree `/tmp/muse-differentiation`) | [differentiation.md](differentiation.md) | 13 | `<pending>` | v1.14.0 | active (cron `291e935d`, session-only) |
