...
|---|---|---|---|---|---|---|
| `recall-spine` | 개인 기억/회상 비서 golden path 강화 (worktree `/tmp/muse-recall-spine`) | [recall-spine.md](recall-spine.md) | 4 | `loop/recall-spine` | v2.1.0 | active (cron `ffe5773d`, session-only, Tier1) |
