...
> 이 표가 실측 신뢰도의 단일 지표입니다. **G1~G10 전부 측정 완료**, 그중 안전·핵심 4종은 반복으로
> pass^k 확보: **G8 pass^10(적대 케이스 매번 FAIL)·G2 pass^6(3역할 연쇄)·G9 pass^5(정상 PASS)·
> G10 pass^5(빈 기준 매번 막힘)**. 세 안전 게이트(틀린 빌드 거부·올바른 빌드 통과·기준 없으면 차단)가
> 비결정성에도 한 번도 새지 않음. 남은 단계는 결정론적 소형 과제(G3·G5·G6·G7)의 반복 표본 확대.
