...
> 이 표가 실측 신뢰도의 단일 지표입니다. **G1~G11 전부 측정 완료**, 그중 핵심 6종은 반복으로
...
> 매번 FAIL)**. 안전 게이트(틀린 빌드 거부·올바른 빌드 통과·기준 없으면 차단·미묘한 부분충족도 거부)가
> 비결정성에도 한 번도 새지 않음 — 다음은 더 다양한 미묘 버그류·연쇄 반복으로 확장.
