...
const BATTERIES = [
  ...
  { axis: "① self-improve: credit assignment (does feedback actually reach a strategy?)", file: "scripts/eval-playbook-credit.mjs", name: "playbook-credit" },
  { axis: "① self-improve: rule-vs-rule conflict detection (learn-time gate for selectBehaviouralRules)", file: "apps/cli/scripts/verify-rule-conflict.mjs", name: "rule-conflict" },
