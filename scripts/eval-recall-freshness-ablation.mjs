...
export function renderSvg(result) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" role="img" aria-labelledby="title desc"><title id="title">Muse recall freshness ablation</title><desc id="desc">Four local embedding models, two retrieval arms, and three categories per model.</desc><style>text{font-family:Inter,ui-sans-serif,system-ui,-apple-system,sans-serif;fill:#172033}.title{font-size:25px;font-weight:700}.subtitle{font-size:13px;fill:#536075}.label{font-size:12px;font-weight:650}.category{font-size:12px;fill:#536075}.value{font-size:10px;fill:#475569}.blue{fill:#1d4ed8}.footer{font-size:12px;font-weight:650}</style><rect width="1200" height="735" fill="#ffffff"/><text x="40" y="40" class="title">Recall freshness ablation · ${result.payload.status}</text><text x="40" y="67" class="subtitle">local-live retrieval component · 60 synthetic cases · four models × two trials · no generative requests</text><rect x="430" y="90" width="14" height="10" rx="2" fill="#94a3b8"/><text x="452" y="99" class="subtitle">raw-retrieval</text><rect x="570" y="90" width="14" height="10" rx="2" fill="#2563eb"/><text x="592" y="99" class="subtitle">muse-freshness</text><text x="40" y="128" class="subtitle">Model</text><text x="280" y="128" class="subtitle">Category</text>${body}<line x1="40" y1="680" x2="1160" y2="680" stroke="#dce2ea"/><text x="40" y="710" class="footer">organic personal effectiveness = NOT_PROVEN · agent capability = NOT_RUN · generated cases are not independent truths</text></svg>\n`;
}
